...
def modelPrediction(user_input):
    ...
    with open('prediction_log.txt', 'a') as log_f:
        log_f.write(f"Raw predictions: {y_pred}\n")
        log_f.write(f"Argmax predictions: {y_predict}\n")
        from statistics import mode
        class_label = class_names[mode(y_predict)]
        log_f.write(f"This video is classified as: {class_label}\n\n")
